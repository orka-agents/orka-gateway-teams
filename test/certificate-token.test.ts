...
import { createCertificateNetwork } from '../src/auth/network.js';
...
for (const variant of ['untrusted TLS', 'wrong SAN', 'redirect', 'HTTP error', 'too large', 'headers', 'invalid UTF8', 'invalid JSON', 'invalid OAuth', 'truncated', 'timeout', 'dripping'] as const) {
